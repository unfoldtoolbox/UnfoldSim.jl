...
A Julia package to simulate multivariate time series model-based ERPs, fMRI activity, pupil dilation etc.
If you have one or multiple channel(s), which is a time series of (overlapping) event-related activity and some noise - you might have fun here!
