...
data, events = simulate(MersenneTwister(1), mydesign, signal, UniformOnset(; width=10, offset=5))
lines(data) ## plotting 
...
UnfoldSim.generate(rng, onset::MyManualOnset, simulation::Simulation) = generate(simulation.design).latency
# !!! hint
